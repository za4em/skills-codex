...
5. Derive the scope from the affected module(s) and choose the most specific single scope; never use `*`.
6. Select a type from: `feat`, `fix`, `refactor`, `docs`, `style`, `test`, `chore`, `perf`, `ci`.
